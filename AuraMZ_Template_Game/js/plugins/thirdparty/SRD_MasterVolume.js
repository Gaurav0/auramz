...
Object.defineProperty(ConfigManager, 'masterVolume', {
    ...
    set: function(value) {
		...
		WebAudio.setMasterVolume(AudioManager.masterVolume);
    },
    configurable: true
});

ConfigManager.masterVolume = _.defaultValue;

_.Scene_Boot_onDatabaseLoaded = Scene_Boot.prototype.onDatabaseLoaded;
Scene_Boot.prototype.onDatabaseLoaded = function() {
    _.Scene_Boot_onDatabaseLoaded.call(this);
	WebAudio.setMasterVolume(AudioManager.masterVolume);
};
